...
pygame.init()
game_font = pygame.font.SysFont('Mac', 40)

delay = 30 #as it increases the game becomes slower
...
def apply_ball_movement():
	...
	if(ball_x_pos + ball_x_vel < p1_x_pos + paddle_width) and (p1_y_pos < ball_y_pos + ball_y_vel < p1_y_pos + paddle_height):
		...
		ball_x_pos = WIDTH/2
		ball_y_pos = HEIGHT/2
		ball_x_vel = 10 #the ball will move towards the winner of the previous point after reset 
		ball_y_vel = 0
	...
	ball_y_pos += ball_y_vel #this is done to make a continuous movement of the ball when playing the game
